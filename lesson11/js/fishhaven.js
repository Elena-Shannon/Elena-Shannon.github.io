...
const apiURL = "//api.openweathermap.org/data/2.5/weather?id=5585000&appid=430370a79b47b0401281e2917fbf7a2b&units=imperial";
...
//5-day forecast for Fish Haven


const api = "//api.openweathermap.org/data/2.5/forecast?id=5585000&appid=430370a79b47b0401281e2917fbf7a2b&units=imperial";
     ...
     fetch(requestURL)
         ...
         .then(function (jsonObject) {
             ...
             function filterByName(item) {
                 if (item.name == "Fish Haven") {
                     return true;
                 }
             };

             for (i = 0; i < certainTowns[0].events.length; i++) {
                 document.getElementById("havenEvents").innerHTML += "<p>" + towns[1].events[i] + "</p>";
             }
